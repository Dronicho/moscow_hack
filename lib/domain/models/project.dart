...
class Project with _$Project {
  factory Project(
      ...
      @JsonKey(ignore: true) @Default(null) User? owner,
      @JsonKey(ignore: true) @Default(null) List<User>? members,
      @JsonKey(ignore: true) @Default(null) List<User>? applicants,
      @JsonKey(ignore: true) @Default(false) bool isOwner,
      @JsonKey(ignore: true) @Default(false) bool isMember,
      @JsonKey(ignore: true) @Default(ProjectState.none) state,
      ...
      @JsonKey(name: 'developmentPlan') required String plan}) = _Project;
